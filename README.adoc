...
+
  * Aller dans menu:Settings[Developer Settings > link:https://github.com/settings/tokens:[Personal access tokens^]].
  * Cliquer sur btn:[link:https://github.com/settings/tokens/new:[Generate new token^]]
