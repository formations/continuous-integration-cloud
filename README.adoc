...
+
  * Aller dans menu:Settings[Developer Settings > https://github.com/settings/tokens[Personal access tokens, window="_blank"]].
  * Cliquer sur btn:[https://github.com/settings/tokens/new[Generate new token, window="_blank"]]
